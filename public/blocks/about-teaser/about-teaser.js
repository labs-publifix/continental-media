 ...
 * The photo grid's hover "spotlight" effect is pure CSS (desktop/mouse
 * only, see about-teaser.css) and needs no touch equivalent: it carries
 * no information, just a visual embellishment.
 */
(function () {
  'use strict';
